		...
		<div class="container">
			...
			<div class="right-side">
				...
				<div class="header-widget">
					...
					<a href="{{ route('property.index') }}" class="button border">Submit Property</a>
				</div>
				<!-- Header Widget / End -->
			</div>
			<!-- Right Side Content / End -->
...
<!-- Banner
================================================== -->
<div class="parallax" data-background="../public/images/home-parallax.jpg" data-color="#36383e" data-color-opacity="0.45" data-img-width="2500" data-img-height="1600">
				...
				<div class="carousel-item">
					<div class="listing-item">
						...
						<a href="single-property-page-2.html" class="listing-img-container">
							...
							<img src="../public/images/listing-02.jpg" alt="">
				...
				<div class="carousel-item">
					<div class="listing-item">
						...
						<a href="single-property-page-3.html" class="listing-img-container">
							...
							<div class="listing-carousel">
								<div><img src="../public/images/listing-04.jpg" alt=""></div>
								<div><img src="../public/images/listing-04b.jpg" alt=""></div>
							</div>
...
<div class="container">
	<div class="row">
		...
		<div class="col-md-4">
			...
			<!-- Image Box -->
			<a href="listings-list-with-sidebar.html" class="img-box" data-background-image="../public/images/popular-location-01.jpg">
		...
		<div class="col-md-8">
			...
			<!-- Image Box -->
			<a href="listings-list-with-sidebar.html" class="img-box" data-background-image="../public/images/popular-location-02.jpg">
				<div class="img-box-content visible">
					<h4>Los Angeles</h4>
		...
		<div class="col-md-8">
			...
			<!-- Image Box -->
			<a href="listings-list-with-sidebar.html" class="img-box" data-background-image="../public/images/popular-location-03.jpg">
				<div class="img-box-content visible">
					<h4>San Francisco </h4>
		...
		<div class="col-md-4">
			...
			<!-- Image Box -->
			<a href="listings-list-with-sidebar.html" class="img-box" data-background-image="../public/images/popular-location-04.jpg">
				<div class="img-box-content visible">
					<h4>Miami</h4>
